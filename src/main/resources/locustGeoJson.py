...
'''
python3 -m locust -f locustGeoJson.py --host ws://connector-kafka-ws-promenade-lyon.apps.kube.rcost.unisannio.it/java-websocket/kafka-connector-geojson/ --users 50 --spawn-rate 50 --run-time 1m --headless --html reports/15marzo/report-BASE-GEOJSON-50user-50spawnrate-1pod-2NeoPod-1minutes.html
...
class UserBehavior(TaskSet):
    ...
    def on_start(self):
        uri = "ws://connector-kafka-ws-promenade-lyon.apps.kube.rcost.unisannio.it/java-websocket/kafka-connector-geojson/"
