...
'''
python3 -m locust -f locustMultipleGeoJson.py --host ws://connector-kafka-ws-promenade-lyon.apps.kube.rcost.unisannio.it/java-websocket/kafka-connector-geojson-multiple/ --users 50 --spawn-rate 50 --run-time 1m --headless --html reports/15marzo/report-MULTIPLE-GEOJSON-50user-50spawnrate-1pod-heap2048-2NeoPod-1minutes.html
...
class UserBehavior(TaskSet):
    ...
    def on_start(self):
        uri = "ws://connector-kafka-ws-promenade-lyon.apps.kube.rcost.unisannio.it/java-websocket/kafka-connector-geojson-multiple/"
