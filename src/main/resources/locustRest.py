...
'''
python3 -m locust -f locustRest.py --host ws://connector-kafka-ws-promenade-lyon.apps.kube.rcost.unisannio.it/java-websocket/kafka-connector-rest-coordinates/ --users 50 --spawn-rate 50 --run-time 1m --headless --html reports/23_03_2022/PROVA-report-REST-50user-50spawnrate-1pod-4core-1minutes.html
'''

class UserBehavior(TaskSet):

    def on_start(self):
        uri = "ws://connector-kafka-ws-promenade-lyon.apps.kube.rcost.unisannio.it/java-websocket/kafka-connector-rest-coordinates/"
