...
addr = "ws://connector-kafka-ws-promenade-lyon.apps.kube.rcost.unisannio.it/java-websocket/kafka-connector-geojson-multiple/"
...
def on_open(ws):
    ...
    #ws.send("Lyon_1er_Arrondissement,Lyon_5e_Arrondissement,Lyon_9e_Arrondissement,Amberieux")
